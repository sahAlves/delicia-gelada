...
const $check = document.getElementById("check_senha");
const $inputSenhaAtual = document.getElementById("antes");
const $inputSenhaNova = document.getElementById("nova");

//Função para bloquear as inputs
const block = () => {
    
    if($check.checked){
        $inputSenhaAtual.disabled = "";
        $inputSenhaNova.disabled = "";
    }
    else{

        $inputSenhaAtual.disabled = "disabled";
        $inputSenhaNova.disabled = "disabled";
...
$check.addEventListener("click", () => block());
